...
public class DescendingSortBySum implements BubbleSortSwap {
	...
	public void bubbleSortSwap(int[][] jaggedArray, int firstIndex, int secondIndex, Boolean isSorted) {
		...
		int firstElement = arrayLogic.findSum(jaggedArray[firstIndex]);
		int secondElement = arrayLogic.findSum(jaggedArray[secondIndex]);
